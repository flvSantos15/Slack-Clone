...
import { HiUsers, HiBookmark } from 'react-icons/hi'
...
export function Sidebar() {
  return (
    <div className="flex-[0.3] border-t border-t-solid border-slack-100 max-w-[260px] mt-[60px] bg-slack-300 text-white">
      ...
      <SidebarOptions Icon={MdKeyboardArrowDown} title="Show less" />
    </div>
  )
}
